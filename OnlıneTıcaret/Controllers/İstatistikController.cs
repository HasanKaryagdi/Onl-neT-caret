...
namespace OnlıneTıcaret.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //Linq Sorgular
            //Groupby + Alt sorgu + İç içe sorgular
            //Tarih Sorguları
            //DIstınct,Count,Sum,OrderBY,where,FirstOrDefault
            ...
            ViewBag.d6 = deger6;
            var deger7 = c.Uruns.Count(x => x.Stok <= 500).ToString();
            ViewBag.d7 = deger7;
            ...
            ViewBag.d9 = deger9;
            var deger10 = c.Uruns.Count(x => x.UrunAd == "Kolye").ToString();
            ViewBag.d10 = deger10;
            var deger11 = c.Uruns.Count(x => x.UrunAd == "Mikser").ToString();
            ViewBag.d11 = deger11;
            var deger12 = c.Uruns.GroupBy(x => x.Marka).OrderByDescending(z => z.Count()).Select(y => y.Key)
                .FirstOrDefault();
            ViewBag.d12 = deger12;
            //Ürün ID'si içerisinde 1 olanın,ismini getir                      //En fazla adı geçen ürün
